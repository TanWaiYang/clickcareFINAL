            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                  ...
                  <br />
                  <span className="bg-gradient-to-br from-foreground via-foreground to-foreground/70 bg-clip-text text-transparent">
                    Responded & Processed Immediately
                  </span>
                </h1>

                {/* SUBTITLE */}
                <p className="text-lg text-muted-foreground leading-relaxed max-w-xl font-medium">
                  Connect with our AI clinical assistant for immediate health
                  guidance, effortless appointment scheduling, and personalized
                  care insights—accessible 24/7 to support your medical needs.
                </p>
              </div>
