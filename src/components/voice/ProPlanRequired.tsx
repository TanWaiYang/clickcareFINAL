              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Upgrade to ClickCare Advance or ClickCare Basic to unlock
                    unlimited voice consultations with our AI clinical health
                    assistant.
                  </p>
                </div>
              </div>
        ...
        <Card className="relative overflow-hidden group hover:shadow-xl transition-all duration-300 border-2 hover:border-primary/30 max-w-2xl mx-auto">
          <CardContent className="relative p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              The voice assistant feature is available to ClickCare Advance and
              ClickCare Basic subscribers. Get instant clinical health support
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex items-center gap-3 justify-center">
                ...
                <span className="text-sm">
                  General clinical health guidance
                </span>
              </div>
              <div className="flex items-center gap-3 justify-center">
                <div className="w-2 h-2 bg-primary rounded-full"></div>
                <span className="text-sm">Instant symptom clarification</span>
              </div>
            </div>
